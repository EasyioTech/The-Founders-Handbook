...
export function FunnelChart({ stages, title }: FunnelChartProps) {
  ...
  const amberShades = ["#166534", "#15803d", "#22c55e", "#4ade80", "#86efac", "#bbf7d0"];
    ...
    <div className="my-6">
      ...
      <div className="space-y-2">
          {stages.map((stage, i) => {
            ...
            const bgColor = amberShades[Math.min(i, amberShades.length - 1)];
            return (
...
export function TimelineChart({ events, title, interactive = true }: TimelineChartProps) {
  ...
  const getTypeColor = (type?: string) => {
    switch (type) {
      ...
      case "funding": return "from-teal-500 to-cyan-500";
  ...
  return (
    <div className="my-6">
      ...
      <div className="relative pl-8">
        <div className="absolute left-3 top-2 bottom-2 w-0.5 bg-gradient-to-b from-primary via-amber-500 to-muted rounded-full" />
            ...
            return (
              ...
              >
                ...
                >
                  <div 
                    className={`
                      absolute left-[-17px] top-5 w-4 h-4 rounded-full bg-gradient-to-br ${getTypeColor(event.type)}
